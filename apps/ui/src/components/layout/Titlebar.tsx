  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 ml-[52px]">
        <button
          className="p-1 rounded hover:bg-hover transition-colors text-foreground-dim hover:text-foreground"
          aria-label="Go back"
        >
          <ChevronLeft size={16} />
        </button>
      ...
      <div className="flex-1 flex justify-center px-4">
        <h1 className="text-md font-medium text-foreground truncate max-w-lg" title="/Users/coreyfloyd/git/personal/git-frisky">
          git-frisky
        </h1>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative">
          <Search className="absolute left-3 top-1/2 -translate-y-1/2 text-foreground-dim" size={14} />
          <input
            type="text"
            placeholder="Search..."
            className={cn(
        ...
        <button
          className="p-1.5 rounded hover:bg-hover transition-colors text-foreground-muted hover:text-foreground"
